...
.LINK
    https://maester.dev/docs/commands/Test-ORCA158
#>
function Test-ORCA158{
    ...
    if($testResult){
        ...
        $resultMarkdown += "Your tenant did not pass. Enable Safe Attachments for SharePoint and Teams`n`n%ResultDetail%"
    }
